  ...
  return (
    <>
      ...
      <section className="bg-black min-h-screen p-8">
        <div className="text-white font-bold text-2xl text-center mt-6" style={{ fontFamily: 'Arial, sans-serif' }}>
          카드 패키지 구성
        </div>
        ...
        <div className="flex justify-center mt-6 relative">
          ...
          <img
            src={buttonImage}
            alt="next"
            className="absolute -bottom-10 right-8 cursor-pointer"
            style={{ width: buttonSize.width, height: buttonSize.height }}
            onClick={buttonImage === know ? handleKnowClick : handleNextClick}
          />
        </div>

        <div className="mt-10 ml-8 mb-10 p-4">
          <div className="text-white text-opacity-87 text-left text-base leading-6">
            {textContent.count}
          </div>

          <div className="mt-2 text-white text-left mx-auto max-w-md">
            <span>
        ...
        <div className="text-white font-bold text-2xl text-left ml-6 mt-24" style={{ fontFamily: 'Arial, sans-serif' }}>
          사용 방법
        </div>
          ...
          <div className="w-[24.5rem] h-[21rem] bg-[#f3eadf] rounded-3xl border border-white/13 shadow-lg mx-auto mt-10">
            <div className="flex flex-col gap-4 items-start justify-start w-[307px] mx-auto mt-10 ml-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="text-left text-base leading-6 text-[#1e1d1c]">
                  - 친구들과 서로가 꿈꾸는 창업을 알아보고 효율적으로 아이디에이션 과정을 진행해보세요.
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-gray min-h-screen p-4 overflow-hidden" ref={sectionTwoRef}>
        <div className="flex justify-center mt-10">
          <img src={cardall} alt="cardall" className="w-full max-w-[400px] h-auto" />
        </div>

        <div className="mt-10 mx-auto p-4 max-w-md mt-5">
          <p className="text-white text-left text-base leading-7 font-normal">
            ...
            여정에서의 승리를 응원합니다. 꿈을 향한 여러분들의 첫걸음을 믿고 나아가, 결실을
            이룰 수 있기를 바라겠습니다!
          </p>
        </div>
      </section>
