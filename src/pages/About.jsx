    ...
    <section className='p-5 bg-background h-screen-minus-header'>
      ...
      <section className='relative pb-16 mt-16 space-y-4'>
        ...
        <article className={`relative z-10 ${article}`}>
          ...
          <p>
            <span className='font-bold'>초기 입문 단계인 창업팀</span> 여러분,
          </p>
          <p>질문에 답하고 기록하며</p>
          <p>
            <span className='font-bold'>복잡한 머릿속을 정리</span>해 보세요!
          </p>
        </article>
        <article className={`relative z-10 ${article}`}>
          <h4 className='mb-3 text-center text-title'>세번째</h4>
          <p>
            <span className='font-bold'>팀원 또는 부원을 선발</span>할 때 적절한 질문카드를
          </p>
          <p>
            활용하여 <span className='font-bold'>면접을 성사</span>시키세요!
          </p>
        </article>
      </section>
    </section>
